...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonGoMensajes = findViewById(R.id.btnGoMensajes);
        buttonGoMensajes.setOnClickListener(v -> {
            Intent intent = new Intent(MenuActivity.this, MensajeActivity.class);
            startActivity(intent);
        });
    }
